...
Rewritten by @rjleveque to use multiprocesssing.Pool rather than mpi4py
...
def run_parallel_green(home,project_name,station_file,
                       model_name,dt,NFFT,static,dk,pmin,pmax,
    ...
    ksources = list(range(source.shape[1]))
